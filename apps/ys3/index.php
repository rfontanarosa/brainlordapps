			...
			<div class="row">
				<div class="col-xs-12 col-md-12 col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul>
								<li>{f7}{COLOR}{f0}{LEFT}{TOP}{f1}{WIDTH}{HEIGHT}{f3}</li>
								<li>{f7} = NEW, {f5} = WAIT</li>
								<li>{left : {min : '02', max : '1B'}, top : {min : '04'}}</li>
								<li>{width : {min: '01', max : '1A'}, height : {max  : '09'}}</li>
								<li>PLACES (SAVE): from 427 to 543 (MAX 25)</li>
								<li>ITEMS (MENU): from 629 to 670 (MAX ?)</li>
								<li>ITEMS (TAKEN): from 671 to 711 (MAX 21, PADDING-LEFT 4)</li>
								<li>PLACES (MAP): from 712 to 717 (MAX 18)</li>
							</ul>
						</div>
					</div>
				</div>
