			...
			<div class="row">
				<div class="col-xs-12 col-md-12 col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<ul>
								<li>{ae}=&hellip; {n'}, {l'}, {c'}, {d'}, {C'}, {D'}</li>
								<li>MAP NAMES - [1 - 42] - MAX 15 - <a href="images/preview/box-game.png">PREVIEW</a></li>
								<li>MESSAGES - [43 - 214] - <a href="images/preview/box-alert.png">PREVIEW</a></li>
								<li>MONSTER NAMES - [215 - 328] - <a href="images/preview/box-alert.png">PREVIEW</a></li>
								<li>ITEM NAMES - [329 - 442] - <a href="images/preview/box-item-name.png">PREVIEW</a></li>
								<li>ITEM DESCRIPTIONS - [443 - 490] - <a href="images/preview/box-alert.png">PREVIEW</a></li>
								<li>TEXT - [491 - 671] - <a href="images/preview/box-dialog.png">PREVIEW</a></li>
								<li>TEXT - [672 - 679] - <a href="images/preview/box-narration.png">PREVIEW</a></li>
								<li>SIGNS - [680 - 754] - <a href="images/preview/box-sign.png">PREVIEW</a></li>
								<li>MENU &amp; PROMPTS - [755 - 770] - <a href="images/preview/box-dialog.png">PREVIEW</a></li>
								<li>SHOP NAMES - [771 - 775] - <a href="images/preview/box-shop.png">PREVIEW</a></li>
								<li>SHOP MESSAGES - [776 - 880] - <a href="images/preview/box-shop.png">PREVIEW</a></li>
								<li>SCROLLING TEXT - [881 - ] - <a href="images/preview/box-narration.png">PREVIEW</a></li>
							</ul>
						</div>
					</div>
				</div>
