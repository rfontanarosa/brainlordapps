...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/assets/css/bootstrap.custom.css?<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/assets/css/bootstrap.custom.css'); ?>">
    <link rel="stylesheet" href="/node_modules/mumble-previewer/dist/css/styles.css?<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/node_modules/mumble-previewer/dist/css/styles.css'); ?>">
    <script src="/node_modules/mumble-previewer/dist/index.js?<?php echo filemtime($_SERVER['DOCUMENT_ROOT'] . '/node_modules/mumble-previewer/dist/index.js'); ?>"></script>
  ...
  <body>
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
      <div id="my-toast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
