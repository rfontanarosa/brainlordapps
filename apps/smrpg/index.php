...
<html lang="en">
	...
	<?php if (UserManager::isLogged() && UserManager::getRole(APPLICATION_ID) == 'user'): ?>
		...
		<div class="container-fluid mb-3">
			<a class="btn btn-light btn-sm" href="https://www.mariowiki.com/Super_Mario_RPG:_Legend_of_the_Seven_Stars" target="_blank">Super Mario Wiki&nbsp;<i class="fas fa-external-link-alt"></i></a>
		</div>
